const nuLoc={
    ...
    nu_fNameTitle:'.css-1bb9xp4 > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_lNameTitle:'div.css-rfnosa:nth-child(2) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_phoneNumTitle:'div.MuiGrid-root:nth-child(3) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_emailTitle:'div.MuiGrid-root:nth-child(4) > div:nth-child(1) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_officeNameTitle:'div.MuiGrid-root:nth-child(5) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_roleTitle:'div.MuiGrid-root:nth-child(6) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_userStatusTitle:'div.MuiGrid-root:nth-child(7) > div:nth-child(1) > label:nth-child(1) > p:nth-child(1)',
    nu_fNameAlert:'.css-1bb9xp4 > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > p:nth-child(3) > p:nth-child(1)',
    nu_lNameAlert:'div.css-rfnosa:nth-child(2) > div:nth-child(1) > div:nth-child(1) > p:nth-child(3) > p:nth-child(1)',
    nu_phoneNumAlert:'div.MuiGrid-root:nth-child(3) > div:nth-child(1) > div:nth-child(1) > p:nth-child(3) > p:nth-child(1)',
    nu_emailAlert:'div.MuiGrid-root:nth-child(4) > div:nth-child(1) > div:nth-child(1) > p:nth-child(3) > p:nth-child(1)',
...
async function checkPageTexts(driver){
    ...
    await temp1.should.equal('Συμπληρώστε τα στοιχεία του χρήστη γραφείου ΚΥΕΠΙΧ');    
}
...
async function checkStatusCheckBox(driver,checked){
    ...
    await temp1.should.equal("Αυτόματη αλλαγή κατάστασης χρήστη ΚΥΕΠΙΧ σε 'ΕΝΕΡΓΟΣ' μετά απο την πρώτη σύνδεση στο σύστημα");
    temp1=await driver.findElement(By.css(nuLoc.nu_statusCheckbox)).getAttribute('value');
    temp2=checked;
    //console.log(temp2);
...
async function setOffice(driver,ofName){
    ...
    if(temp1!=ofName){
        ...
        temp1=await driver.findElements(By.className('MuiList-root MuiList-padding MuiMenu-list css-r8u8y9'));
        for(temp2 of temp1){
        ...
        temp1=await temp4.findElements(By.className('MuiMenuItem-root MuiMenuItem-gutters MuiButtonBase-root css-1imvk2h'));
        for(temp2 of temp1){
...
module.exports={nuLoc,checkFNameField,checkLNameField,
    checkPhoneNumField,checkEmailField,checkOfficeNameField,
    checkUserStatusField,checkRoleField,checkBtns,checkPageTexts,
    checkCancelBtn,checkBackBtn,checkCreateBtn,checkStatusCheckBox,
    setOffice,setRole,setStatusCheckbox,checkAlerts,checkAlertBox
